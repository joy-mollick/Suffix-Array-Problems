...

{
    ...
    long long num_of_duplicate_substrings=0;
    for(int i=0;i<n;i++) num_of_duplicate_substrings+=(long long)lcp[i];
    long long N=n;
    long long total_substrings=N*(N+1)/2;
    long long ans=total_substrings-num_of_duplicate_substrings;
    cout<<ans<<endl;
